...
<div id="rules-overlay" class="hidden" style="position:fixed; top:0; left:0; right:0; bottom:0; background:var(--bg-1); z-index:9999; overflow-y:auto; transition: transform 0.3s ease;">
    <div style="position:sticky; top:0; background:var(--bg-1); padding: 16px 20px; display:flex; align-items:center; gap: 12px; border-bottom: 1px solid var(--border-color); z-index:10;">
        <button id="btn-close-rules" style="background:none; border:none; color:var(--text-1); padding:0; display:flex; cursor:pointer;">
            <span class="material-symbols-outlined">arrow_back</span>
        </button>
        <div style="font-weight:700; font-size:18px;">Regolamento Ufficiale</div>
    </div>
    
    <div style="padding: 24px 20px 60px; color: var(--text-2); font-size: 14px; line-height: 1.6;">
        <h3 style="color:var(--text-1); margin: 0 0 8px;">1. Struttura</h3>
        ...
        <h3 style="color:var(--text-1); margin: 0 0 8px;">2. Rosa</h3>
        ...
        <h3 style="color:var(--text-1); margin: 0 0 8px;">3. Formazione</h3>
        ...
        <h3 style="color:var(--text-1); margin: 0 0 8px;">4. Panchina e sostituzioni</h3>
        ...
        <h3 style="color:var(--text-1); margin: 0 0 8px;">5. Fonte dati e voti</h3>
        ...
        <h3 style="color:var(--text-1); margin: 0 0 8px;">6. Bonus e malus</h3>
        <p style="margin-bottom: 8px;">I punteggi sono calcolati automaticamente in base alle prestazioni reali:</p>
        <div style="background:var(--bg-2); padding:12px; border-radius:8px; margin-bottom:20px;">
        ...
        <h3 style="color:var(--text-1); margin: 0 0 8px;">7. Esito della sfida</h3>
        ...
        <h3 style="color:var(--text-1); margin: 0 0 8px;">8. Classifica finale</h3>
        ...
        <h3 style="color:var(--text-1); margin: 0 0 8px;">9. Consegna formazione</h3>
        ...
        <h3 style="color:var(--text-1); margin: 0 0 8px;">10. Mercato</h3>
        ...
        <h3 style="color:var(--text-1); margin: 0 0 8px;">11. Calendario</h3>
        ...
        <h3 style="color:var(--text-1); margin: 0 0 8px;">12. Regola finale</h3>
