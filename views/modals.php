...
<div id="rules-overlay" class="hidden" style="position:fixed; top:0; left:0; width:100%; height:100%; background:var(--bg); z-index:999999; overflow-y:auto; transform:translateY(100%); transition:transform 0.3s var(--ease);">
    ...
    <div style="padding: 16px 0 80px;">
        ...
        <div class="admin-section">
            ...
            <div style="font-size: 13.5px; color: var(--text-2); line-height: 1.5;">FM26 si svolge parallelamente al mondiale reale ed è diviso in 8 giornate.<br>Il torneo segue una formula campionato tutti-contro-tutti per 7 giornate, seguite da una <strong>giornata 8 di finali</strong> dirette in base alla classifica (1-2, 3-4, 5-6, ...).</div>
        </div>
        ...
        <div class="admin-section">
            ...
            <div style="display: flex; flex-direction: column; gap: 6px; margin-top: 4px;">
                <div style="display: flex; align-items: center; gap: 8px;"><span class="role-badge badge-POR" style="margin: 0;">POR</span> <span style="font-size: 13.5px; color: var(--text-2);">4 POR</span></div>
                <div style="display: flex; align-items: center; gap: 8px;"><span class="role-badge badge-DIF" style="margin: 0;">DIF</span> <span style="font-size: 13.5px; color: var(--text-2);">9 DIF</span></div>
                <div style="display: flex; align-items: center; gap: 8px;"><span class="role-badge badge-CEN" style="margin: 0;">CEN</span> <span style="font-size: 13.5px; color: var(--text-2);">9 CEN</span></div>
                <div style="display: flex; align-items: center; gap: 8px;"><span class="role-badge badge-ATT" style="margin: 0;">ATT</span> <span style="font-size: 13.5px; color: var(--text-2);">7 ATT</span></div>
            </div>
        </div>
        ...
        <div class="admin-section">
            ...
            <div style="font-size: 13.5px; color: var(--text-2); line-height: 1.5;">Per ogni giornata schiererai 11 titolari con modulo selezionabile, rispettando questi minimi:</div>
            <div style="display: flex; flex-direction: column; gap: 4px; margin-top: 4px;">
                <div style="display: flex; align-items: center; gap: 8px; font-size: 13.5px; color: var(--text-2);"><span class="material-symbols-outlined" style="font-size: 14px; color: var(--blue);">check_circle</span> 1 POR</div>
                <div style="display: flex; align-items: center; gap: 8px; font-size: 13.5px; color: var(--text-2);"><span class="material-symbols-outlined" style="font-size: 14px; color: var(--blue);">check_circle</span> Almeno 3 DIF</div>
                <div style="display: flex; align-items: center; gap: 8px; font-size: 13.5px; color: var(--text-2);"><span class="material-symbols-outlined" style="font-size: 14px; color: var(--blue);">check_circle</span> Almeno 3 CEN</div>
                <div style="display: flex; align-items: center; gap: 8px; font-size: 13.5px; color: var(--text-2);"><span class="material-symbols-outlined" style="font-size: 14px; color: var(--blue);">check_circle</span> Almeno 1 ATT</div>
            </div>
        </div>
        ...
        <div class="admin-section">
            ...
            <div style="font-size: 13.5px; color: var(--text-2); line-height: 1.5;">La panchina è libera. Sono consentite un <strong>massimo di 5 sostituzioni</strong> per giornata.<br><br>Se un titolare non va a voto, entrerà il primo panchinaro disponibile con ruolo compatibile al modulo.</div>
        </div>
        ...
        <div class="admin-section">
            ...
            <div style="display: flex; flex-direction: column; gap: 10px; margin-top: 8px;">
                ...
                <div style="background: var(--red-soft); padding: 12px; border-radius: var(--r-sm); border: 1px solid rgba(232,57,42,0.15);">
                    ...
                    <div style="display: flex; justify-content: space-between; font-size: 13px; color: var(--text);"><span>Gol subito</span><span style="font-family: var(--mono); font-weight: 700;">-1</span></div>
                </div>
            </div>
        </div>
        ...
        <div class="admin-section">
            ...
            <div style="font-size: 13.5px; color: var(--text-2); line-height: 1.5;">Vince la sfida chi ottiene il punteggio totale più alto (NO soglie gol).<br><br><strong style="color: var(--text);">Punti:</strong> Vittoria 3pt, Pareggio 1pt, Sconfitta 0pt.<br><br><strong style="color: var(--text);">Criteri parità:</strong><br>1. Punti<br>2. FP totali<br>3. Numero vittorie<br>4. Sorteggio</div>
        </div>
        ...
        <div class="admin-section">
            ...
            <div style="font-size: 13.5px; color: var(--text-2); line-height: 1.5;">
                <strong style="color: var(--text);">Formazione:</strong><br>Inserita prima dell'inizio della prima partita utile. In caso di dimenticanza, vale l'ultima schierata.
            </div>
            
            <div style="background: var(--surface-2); border: 1px solid var(--border); border-radius: var(--r-sm); padding: 12px; margin-top: 12px;">
                <div style="font-size: 10px; color: var(--text-3); margin-bottom: 6px; text-transform: uppercase; font-family: var(--mono);">Campionato</div>
                <div style="display: flex; justify-content: space-between; font-size: 12.5px; color: var(--text); margin-bottom: 4px;"><span>G1 - G3</span><span style="font-family: var(--mono);">Gironi</span></div>
                ...
                <div style="display: flex; justify-content: space-between; font-size: 12.5px; color: var(--blue); font-weight: 700;"><span>G8</span><span style="font-family: var(--mono);">Finali</span></div>
            </div>
        </div>
